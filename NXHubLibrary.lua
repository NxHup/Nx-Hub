...
function NXHub:CreateWindow(config)
    ...
    local FpsLbl = Instance.new("TextLabel"); FpsLbl.Size = UDim2.new(1, -12, 0, 16); FpsLbl.Position = UDim2.new(0, 8, 0, 3); FpsLbl.BackgroundTransparency = 1; FpsLbl.Text = "⚡ FPS: --"; FpsLbl.TextColor3 = Color3.fromRGB(0, 240, 255); FpsLbl.Font = Enum.Font.GothamBold; FpsLbl.TextSize = 10; FpsLbl.TextXAlignment = Enum.TextXAlignment.Left; FpsLbl.Parent = StatusWidget
    local PingLbl = Instance.new("TextLabel"); PingLbl.Size = UDim2.new(1, -12, 0, 16); PingLbl.Position = UDim2.new(0, 8, 0, 19); PingLbl.BackgroundTransparency = 1; PingLbl.Text = "📶 Ping: -- ms"; PingLbl.TextColor3 = Color3.fromRGB(0, 255, 150); PingLbl.Font = Enum.Font.GothamBold; PingLbl.TextSize = 10; PingLbl.TextXAlignment = Enum.TextXAlignment.Left; PingLbl.Parent = StatusWidget
    local TimeLbl = Instance.new("TextLabel"); TimeLbl.Size = UDim2.new(1, -12, 0, 16); TimeLbl.Position = UDim2.new(0, 8, 0, 35); TimeLbl.BackgroundTransparency = 1; TimeLbl.Text = "⏱️ Time: --"; TimeLbl.TextColor3 = Color3.fromRGB(200, 180, 255); TimeLbl.Font = Enum.Font.GothamBold; TimeLbl.TextSize = 10; TimeLbl.TextXAlignment = Enum.TextXAlignment.Left; TimeLbl.Parent = StatusWidget
    ...
    function WindowObj:AddTab(tabConfig)
        ...
        local TabBtn = Instance.new("TextButton"); TabBtn.Size = UDim2.new(1, 0, 0, 34); TabBtn.BackgroundColor3 = Color3.fromRGB(20, 22, 34); TabBtn.Text = name; TabBtn.TextColor3 = Color3.fromRGB(150, 155, 175); TabBtn.Font = Enum.Font.GothamMedium; TabBtn.TextSize = 12; TabBtn.TextXAlignment = Enum.TextXAlignment.Left; TabBtn.Parent = Sidebar
        ...
        local Indicator = Instance.new("Frame"); Indicator.Size = UDim2.new(0, 3, 0, 18); Indicator.Position = UDim2.new(0, -10, 0.5, -9); Indicator.BackgroundColor3 = Color3.fromRGB(0, 240, 255); Indicator.Visible = false; Indicator.Parent = TabBtn
